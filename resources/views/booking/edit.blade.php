        ...
        <div class="card-body">
            <form action="{{ route('booking.update', $booking->id) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <select name="tutor_id" id="tutor_id" class="form-control @error('tutor_id') is-invalid @enderror" required>
                        ...
                        @foreach($tutors as $tutor)
                            <option value="{{ $tutor->id }}" {{ old('tutor_id', $booking->tutor_id) == $tutor->id ? 'selected' : '' }}>
                                {{ $tutor->name }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="mb-3">
                    ...
                    <select name="subject_id" id="subject_id" class="form-control @error('subject_id') is-invalid @enderror" required>
                        ...
                        @foreach($subjects as $subject)
                            <option value="{{ $subject->id }}" {{ old('subject_id', $booking->subject_id) == $subject->id ? 'selected' : '' }}>
                ...
                <div class="mb-3">
                    ...
                    <input type="datetime-local" name="scheduled_time" id="scheduled_time" class="form-control @error('scheduled_time') is-invalid @enderror" value="{{ old('scheduled_time', $booking->scheduled_time->format('Y-m-d\TH:i')) }}" required>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" name="price" id="price" class="form-control @error('price') is-invalid @enderror" value="{{ old('price', $booking->price) }}" step="0.01" min="0">
                    </div>
                    @error('price')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
